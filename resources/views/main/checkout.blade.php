<template>
    <div id="main-container" class="container mt-2">
        ...
        <div class="card" style="width: 100%;">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="row container">
                    <div class="col-6 p-0 project-title">
                        <i class="fas fa-cash-register mr-3"></i>Online Payment Portal
                    </div>
                    <div class="col-6 text-right p-0 username">
                        <a href="#">{{ username }}</a>
                    </div>
                </div>
            </div>
